...
const PrizeCard = ({ item }) => {
  return (
    ...
    >
      ...
      <h4 className="text-base sm:text-3xl lg:text-lg font-semibold capitalize line-clamp-3">
        {item.text}
      </h4>
      <h4 className="text-base sm:text-3xl lg:text-lg font-semibold line-clamp-3">
        {item.text1}
      </h4>
      <h4 className="text-base sm:text-3xl lg:text-lg font-semibold capitalize line-clamp-3">
        {item.text2}
