...
const PrizeCard = ({ item }) => {
  return (
    ...
    >
      <h3 className="text-4xl lg:text-3xl font-semibold capitalize line-clamp-1">
        {item.title}
      </h3>
      ...
      <h4 className="text-base sm:text-4xl lg:text-lg font-semibold capitalize line-clamp-3">
        {item.text}
      </h4>
      <h4 className="text-base sm:text-4xl lg:text-lg font-semibold line-clamp-3">
        {item.text1}
      </h4>
      <h4 className="text-base sm:text-4xl lg:text-lg font-semibold capitalize line-clamp-3">
        {item.text2}
