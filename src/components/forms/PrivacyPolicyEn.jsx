  ...
  return (
    <div className="space-y-6 text-gray-500 text-lg  mb-8">
      ...
      <p className="animated fadeInUp">
        ...
        Limited (the "Company").
        <br />
        2. This Event starts on 23 August 2022 at 2 p.m. (Hong Kong time) and
        ...
        that you accept these Terms and Conditions and will be bound by them. If
        you do not accept these Terms and Conditions, please do not participate
        in this Event. The Company reserves the right to disqualify any
        Participant who violates these Terms and Conditions.
        <br />
        6. You will be asked to provide personal data to the Company when you
        participate in this Event. The Company may collect and compile further
        ...
        without notice. Any discovery of fraudulent cases may result in
        ...
        be disqualified and the awarded prize will be forfeited without notice
        at the sole discretion of the Company. No supplemental lucky draw will
        be arranged by the Company. The Company shall not give any declaration,
        ...
        conduct of their staff, managers or agents. You should resolve any
      ...
      <p className="animated fadeInUp">
        1. This event is organized by The Hong Kong and China Gas Company
        Limited, and its entrusted service provider (if any) is responsible for
        the coordination and execution
        <br />
        2. Data collected from Participants (including but not limited to data
        collected under the missions mentioned under clause 10) will only be
        used for purposes related to this Event. <br />
        3. Information (including personal data) collected during this Event may
        be disclosed and transferred to the data processor or other agents of
        the Company who are engaged to conduct or monitor this Event, for such
        purpose only, without the relevant participant's prior consent. Such
        information will be properly stored and encrypted, and destroyed within
        90 days of this Event’s conclusion.
        <br />
        4. If you do not provide us with the requested data, you may not
        participate in the Event. <br />
        5. Please browse the Privacy Policy Statement of the Company via
        <a
      ...
      <p className="animated fadeInUp">
        ...
        resulting from any unforeseen circumstances, such as technical failure
        or incompatibility issues with other software, the Company assumes no
        responsibility.
        <br />
        3. All information is subject to the records of the Company. Any
        incorrect, incomplete, missing, false or duplicated entry will be
        disqualified. Notification will not be sent for any voided registration.
        <br />
        4. If a Participant is found to use a false name and/or fake account,
        and/or used details that are fraudulent or misappropriated from any
        third party and/or adopt any way to invade and/or modify/write/use a
        computer program or dishonestly to participate in this Event, the
        Company reserves the sole right to cancel the Participant’s entitlement
        to the participation in this Event and/or to the prize and to retrieve
        the prize if it had been collected, without notice and explanation. The
        Company further reserves all rights against the Participant and the
        Participant shall bear all related and associated responsibilities,
        liabilities and consequences.
        <br />
        5. If any information delivered or registered by the Participant, Winner
        or the Company is lost, incorrect, unidentifiable, invalidated or
        damaged due to computer, network, telephone, technology or other reasons
        that are not attributable to the Company, the Company shall not assume
        any legal responsibility, and Participants and/or Winner do not hold the
        right to object or to appeal.
        <br />
        6. Any fraud and/or abuse of this Event by you (as determined by the
        Company at its sole discretion) will result in forfeiture of your
        eligibility to participate in this Event. The Company reserves the right
        to cancel your entitlement to the participation in this Event and/or to
        the prize and to retrieve the prize obtained by you inappropriately
        pursuant to any fraud and/or abuse without notice and/or take legal
        action in such instances to recover any loss and/or damages suffered by
        the Company.
        <br />
        7. If this Event cannot be run as planned due to infection by computer
        virus, bugs, worms, Trojan horses, server attacks, tampering,
        ...
        <br />
        9. All the photos are for reference only and the prizes are subject to
        the actual products.
        <br />
        10. If there is any discrepancy between the information contained in the
        promotional materials and these Terms and Conditions, these Terms and
        Conditions shall prevail.
        <br />
        11. This Event is held within Hong Kong. These Terms and Conditions
        shall be governed by and construed in accordance with the laws of Hong
        Kong. Each Participant submits to the exclusive jurisdiction of the
        courts of Hong Kong.
        <br />
        12. These Terms and Conditions shall be interpreted by the Company. In
        case of any dispute, the decision of the Company shall be final.
        <br />
        13. It is the Winner’s responsibility to comply (at his/her own
        expenses) with any laws requiring payment of any tax, duty, levy or
        similar impost relating to the award of the prize, and the Company shall
        have no responsibility in respect thereof.
        <br />
        14. If the Participant or Winner violates any rules or commits any
        illegal acts that result in any losses on the part of the Company or any
        third parties, the relevant Participant or Winner will be liable for all
        the liabilities.
        <br />
        15. A person who is not a party to these Terms and Conditions may not
        enforce any of the terms hereunder under the Contracts (Rights of Third
        Parties) Ordinance (Cap 623 of the Laws of Hong Kong).
        <br />
        16. These Terms and Conditions are governed by and will be construed in
        accordance with Hong Kong law. You submit to the exclusive jurisdiction
        of the Hong Kong courts.
        <br />
        17. In the case of any discrepancy or inconsistency between the Chinese
